...
public class myFifthApp {
    public static void main(String[] args) {
        ...
        // Task 2: Call the method that prints a box of characters
        printCharacterBox('#', 10, 5); // Example: print '#' 10 times per line, for 5 lines
    }

    // Method: prints a character in a box shape based on width and height
    private static void printCharacterBox(char character, int width, int height) {
        for (int i = 0; i < height; i++) { // Loop through the number of lines
            for (int j = 0; j < width; j++) { // Print the character multiple times per line
